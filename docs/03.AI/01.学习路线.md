...
| **3. 编排** | [大编排](/pages/ai-langchain/) | LangChain：链、记忆、工具调用、检索增强 | 已有 |
...
4. 再读 [大编排](/pages/ai-langchain/)，用 LangChain 把链、记忆、工具与 RAG 串成流水线。
5. 随后继续往上：选一个小场景（如文档问答、客服助手），按 LangGraph → MCP → Skill/Agent 叠能力。
