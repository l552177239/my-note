...
---
## 10. 下一篇
下一篇：**SpringBoot 快速入门**（已生成，可回顾）。  
之后进入 Web 核心章节：**SpringBoot REST 接口开发、参数校验与 JSON 序列化**。
---
## 附：更新后的笔记系列规划
1. Java 介绍（已完成）
...
5. Maven 项目管理
6. JUnit 单元测试
7. **Lombok 与日志框架 SLF4J + Logback（本文）**
8. SpringBoot 快速入门
9. SpringBoot REST 接口开发、参数校验与 JSON 序列化
10. SpringBoot 全局异常与跨域处理
11. MyBatis 数据库开发
12. Java 集合框架
13. Java Lambda & Stream 流
14. Java 多线程与并发（重点对比 JS 事件循环）
15. JVM 基础
16. 实战项目：RESTful 后端系统