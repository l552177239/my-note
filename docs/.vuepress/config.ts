...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  // 覆盖 Sidebar：面试题页在 .sidebar 渲染三级题目目录
  chainWebpack: (config) => {
    config.resolve.alias.set(
      '@theme/components/Sidebar.vue',
      resolve(__dirname, 'theme/components/Sidebar.vue')
    )
  },
  ...
  base: '/my-note/', // https://l552177239.github.io/my-note/
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        link: '/ai/',
        items: [
          { text: 'AI应用开发基础', link: '/pages/ai-roadmap/' },
          { text: 'AI应用开发技术', link: '/pages/ai-eng-roadmap/' },
        ],
      },
      {
        text: '文档',
    ...
    repo: 'l552177239/my-note', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'Lious', // 必需
      link: 'https://github.com/l552177239', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'Lious', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
