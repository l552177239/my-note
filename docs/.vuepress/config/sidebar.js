...
module.exports = {
  ...
  '/04.其他/': [
    ...
    },
    {
      ...
      collapsable: false, //是否可折叠，可选的，默认true
      children: [
        ['10.实用技巧/01.2分钟规则','2分钟规则'],
        ['10.实用技巧/02.面试问题集锦','面试问题集锦'],
        ['10.实用技巧/03.费曼学习法','费曼学习法'],
        ['10.实用技巧/04.笔记方法','笔记方法'],
        ['10.实用技巧/05.提高学习效率的策略','提高学习效率的策略'],
        ['10.实用技巧/06.提高记忆的技巧','提高记忆的技巧'],
        ['10.实用技巧/07.自律小建议','自律小建议'],
        ['10.实用技巧/08.处理问题的思路','处理问题的思路'],
        ['10.实用技巧/09.搜索引擎使用技巧','搜索引擎使用技巧'],
      ]
    },
    ['01.在线工具','在线工具'],
  ],
